---
layout: post
title: "V2ray Easter Egg"
date: 2019-11-08 12:12 +0800
categories: tools
published: true
---

## [David](https://github.com/v2ray/v2ray-core/blob/master/core.go)

```sh
curl https://raw.githubusercontent.com/v2ray/v2ray-core/master/core.go
```

![david](/asserts/v2ray-david.png)

## [lovevictoria](https://github.com/v2ray/v2ray-core/blob/master/infra/control/love.go)

```sh
zz@ubuntu:~/go/src/v2ray.com/core/infra/control/main$ ./main lovevictoria
...
zz@ubuntu:~/go/src/v2ray.com/core/infra/control/main$
